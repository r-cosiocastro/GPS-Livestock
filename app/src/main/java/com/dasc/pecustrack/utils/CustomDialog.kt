...
class CustomAlertDialog(private val context: Context) {
    ...
    fun show() {
        ...
        // Habilitar el botón de aceptar después de un tiempo y mostrar los segundos restantes
            ...
            val runnable = object : Runnable {
                ...
                override fun run() {
                    ...
                    if (seconds-- > 0) {
                        ...
                        //dialog.getButton(Dialog.BUTTON_POSITIVE).setTextColor(context.resources.getColor(R.color.white))
                        //dialog.getButton(Dialog.BUTTON_POSITIVE).setBackgroundColor(context.resources.getColor(R.color.md_theme_light_secondary))
